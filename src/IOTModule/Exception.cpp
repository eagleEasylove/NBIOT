...
CORE_IMPLEMENT_EXCEPTION(MutexException, Exception, "Mutex received")
CORE_IMPLEMENT_EXCEPTION(RWMutexException, Exception, "RWMutex received")
...
CORE_IMPLEMENT_EXCEPTION(NoThreadAvailableException, Exception, "No thread available")
