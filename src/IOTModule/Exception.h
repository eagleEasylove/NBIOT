...
CORE_DECLARE_EXCEPTION(MutexException, Exception)
CORE_DECLARE_EXCEPTION(RWMutexException, Exception)
...
CORE_DECLARE_EXCEPTION(NoThreadAvailableException, Exception)
